...
SELECT PRONAL
   ...
   IF MDOK2='  '
      MDOK2=ALLTRIM(MMAGGOT)
   ENDIF

   IF MMATDOK<>'   '
      MMAGMAT=SUBSTR(MMATDOK,2,2)
   ENDIF   
...
IF MKGOT='D'
   ...
   *-------NASLI SMO KALKULACIJU SAD DODAJEMO STAVKE
   ...
   IF MMIMA=0
         ...
         REPLACE DATPRI WITH MDAT1
         REPLACE DATPDV WITH MDAT1
...
ENDIF
   ...
   *-----------PUNIMO RACUNE
   ...
   SELECT PRONAL
   IF MDOK1='V'
      KMKAL='FAK'+ALLTRIM(MDOK2)+'.DBF'
      KMKALG='FAKG'+ALLTRIM(MDOK2)+'.DBF'
   ELSE
      KMKAL='TMFAK'+ALLTRIM(MDOK2)+'.DBF'
      KMKALG='TMFAKG'+ALLTRIM(MDOK2)+'.DBF'
   ENDIF
   MIMA=0
   MMIMA=0
   USE &KMKALG IN 0 ALIAS KALG
   ...
   SELECT KALPRN
   SET ORDER TO 1
   LOCATE FOR ALLTRIM(FVRSTA)=ALLTRIM(MFPGOTF)
   IF FOUND()
      MSEMA=SEMA
      MFVRSTA=FVRSTA
      MVPDV=VPDV
   ...
   *--------PRVO PUNIMO SIROVINE---------
   FOR I=1 TO 4
      ...
      case I=1
         MMAG=MMAGPOLU
         MFP=MFPPOLU
         COPY TO &KKOCKA2 FOR PSIF<>SPACE(5)
      case I=2
         MMAG=MMAGMAT
         MFP=MFPMAT
      ...
      IF RECCOUNT()>0
         ...
         case I=1
            MMSIF=PSIF
            REPLACE ALL RSIF WITH PSIF
         case I=2
            MMSIF=MSIF
            REPLACE ALL RSIF WITH MSIF
         case I=3
            MMSIF=PMSIF
            REPLACE ALL RSIF WITH PMSIF
         case I=4
            MMSIF=ASIF
            REPLACE ALL RSIF WITH ASIF
         endcase
         INDEX ON RSIF TAG PSIF
         SET ORDER TO 1
         TOTAL ON RSIF TO &KKOCKA3 FIELDS KOL,IZNOS
         DELETE ALL
         PACK
         ...
         *-------NASLI SMO RACUN SAD DODAJEMO STAVKE
         ...
         IF MMIMA=0
            APPEND BLANK
               ...
               REPLACE NAPOMENAG WITH MRNAZ
               REPLACE RSIF WITH MRSIF2
         ELSE
               REPLACE BRKAL WITH MNBRKAL
               REPLACE BRRAC WITH MRNAL
               REPLACE FVRSTA WITH MFVRSTA
         ...
         *----------SADA PUNIMO TELO KALKULACIJE------------
         ...
         ENDIF
         SELECT KOCKA2
         SET RELATION TO RSIF INTO ROBA
         GO TOP
         DO WHILE.NOT.EOF()
            MRSIF=RSIF
            MRKOL=KOL
            ...
            APPEND BLANK
               ...
               REPLACE NORMATIV WITH MNORMATIV
               IF aasveprok=0
                  replace roba.KOL WITH ROBA.kol-mrkol
               endif
            ENDIF
            SELECT KOCKA2
            SKIP
