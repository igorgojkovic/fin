...
LOCATE FOR BRKAL=MBRKAL
   IF tobjekat='M'
   *REPORT FORM KAL1NOTPIS FOR BRKAL=MBRKAL.AND.KOL<>0 PREVIEW 
      mfile='KAL1NOTPIS'
      uslov="BRKAL=MBRKAL.AND.KOL<>0"
      DO printer_bullzip WITH mdata02,mfile,uslov

   ELSE
   *REPORT FORM KAL1NOTPISV FOR BRKAL=MBRKAL.AND.KOL<>0 PREVIEW 
      mfile='KAL1NOTPISV'
      uslov="BRKAL=MBRKAL.AND.KOL<>0"
      DO printer_bullzip WITH mdata02,mfile,uslov
