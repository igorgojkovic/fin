...
SELECT ROB
SORT ON GRUPA,NAZ TO &KKOCKA 
USE &KKOCKA IN 0 ALIAS KOCKA EXCLU
SELECT KOCKA
INDEX ON GRUPA+NAZ TAG GRNAZ
SET ORDER TO 1 
IF MMAGACIN<>0
   INDEX ON STR(MAGACIN,2,0)+GRUPA5+NAZ TAG MMAG
   SET ORDER TO 2
   GO TOP 
ENDIF   
   ...
   IF MTXTKOL='N'
      IF AGDE=0
      *REPORT FORM ROBPOPISPOD  PREVIEW FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
      ...
      .AND.(MAGACIN=MMAGACIN.OR.MMAGACIN=0);
      .AND.NAZ<>SPACE(30)
   ...
   DO printer_bullzip WITH mdata02,mfiLE,USLOV
      ...
      ELSE
      REPORT FORM ROBPOPISPOD  TO PRINTER PROMPT FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
      .AND.(GRUPA1=MGRUPA1.OR.MGRUPA1=SPACE(3));
      .AND.(GRUPA2=MGRUPA2.OR.MGRUPA2=SPACE(3));
      .AND.(GRUPA3=MGRUPA3.OR.MGRUPA3=SPACE(3));
      .AND.(GRUPA4=MGRUPA4.OR.MGRUPA4=SPACE(3));
   ...
   ELSE
      IF AGDE=0
      *REPORT FORM ROBPOPISPODK  PREVIEW FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
      .AND.(GRUPA1=MGRUPA1.OR.MGRUPA1=SPACE(3));
      .AND.(GRUPA2=MGRUPA2.OR.MGRUPA2=SPACE(3));
      .AND.(GRUPA3=MGRUPA3.OR.MGRUPA3=SPACE(3));
      .AND.(GRUPA4=MGRUPA4.OR.MGRUPA4=SPACE(3));
   ...
   DO printer_bullzip WITH mdata02,mfiLE,USLOV
      ...
      ELSE
      REPORT FORM ROBPOPISPODK  TO PRINTER PROMPT FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
      .AND.(GRUPA1=MGRUPA1.OR.MGRUPA1=SPACE(3));
      .AND.(GRUPA2=MGRUPA2.OR.MGRUPA2=SPACE(3));
      .AND.(GRUPA3=MGRUPA3.OR.MGRUPA3=SPACE(3));
      .AND.(GRUPA4=MGRUPA4.OR.MGRUPA4=SPACE(3));
