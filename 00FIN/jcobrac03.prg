...
*------------OBRACUN ZA GRO
IF PGRO='D'
   REPLACE GRO WITH POV*MCGRO*(100-POPGRO)/100
ELSE
   REPLACE GRO WITH 0
ENDIF
...
SELECT vp
   ...
   *-----OBRACUN POREZA-------------------------------
   ...
   MUKUPNO2=VODA+DOPV+KAN+DOPK+SMECE+GRO   
...
*   REPLACE SVEGA WITH MSVEGA
   MDDUG=VODA+DOPV+KAN+DOPK+smece+ciscenje+grejanje+PORVODA+PORKAN+PORSME+PORGRO+POROST1+POROST2-SOC-RABAT+KAMATA+DINOST1+DINOST2
   MKAMATA=KAMATA
   SELECT VPUPL
   SET ORDER TO 1
   SEEK Mpib
