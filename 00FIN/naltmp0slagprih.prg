...
TOTAL ON BRNAL FIELDS UKPRIH TO &KKOCKA3
ZAP
APPEND FROM &KKOCKA3
SET ORDER TO 1
GO TOP
...
USE NAL IN 0
SELECT NAL
COPY TO &KKOCKA4 FOR SUBSTR(konto,1,1)='6'
USE
...
ENDDO   
GO TOP
TNAZIV=' KNJIGA PRIHODA I RASHODA SLAGANJE PRIHODA '
TOBJEKAT='0'
TTVREDNI='0'
