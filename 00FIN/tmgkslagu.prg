...
SELECT TM
TOTAL ON dATDOK TO &KKOCKA2 FIELDS USLUGE
USE
USE &KKOCKA2 IN 0 ALIAS KOCKA2 EXCLU
SELECT KOCKA2
REPLACE ALL VREDPROD WITH USLUGE
USE
SELECT KOCKA
APPEND FROM &KKOCKA2
...
APPEND FROM &KKOCKA4
SET ORDER TO 1
TOTAL ON DTOS(DATDOK) TO &KKOCKA2 FIELDS POT,VREDPROD
DELETE ALL
PACK
