...
SELECT vp
   ...
   IF IMARABAT=1
      MRABOSNOV=VODA+DOPV+KAN+DOPK+SMECE+DINOST1+DINOST2
   ELSE
      MRABOSNOV=0
   ENDIF      
   *MMAKSPOT=MMES*15
   ...
   *-----OBRACUN POREZA-------------------------------
   ...
   MUKUPNO=VODA+DOPV+KAN+DOPK+SMECE+DINOST1+DINOST2
   ...
   *------porez     
   ...
   REPLACE SVEGA WITH UKUPNO-RABAT+PORVODA+PORKAN+PORSME+POROST1+POROST2

   MOSNOV=MUKUPNO-MSOC-mrabat+MPORVODA+MPORKAN+MPORSME+MPOROST1+MPOROST2
...
*   REPLACE SVEGA WITH MSVEGA
   MDDUG=VODA+DOPV+KAN+DOPK+smece+PORVODA+PORKAN+PORSME+POROST1+POROST2-SOC-RABAT+KAMATA+DINOST1+DINOST2
   MKAMATA=KAMATA
*   SELECT VPUPL
*   SET ORDER TO 1
*   SEEK Mpib
