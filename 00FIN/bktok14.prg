...
replace ALL plankv WITH  ROUND(plan/4,0) FOR RECNO()<=38
GO top
DO while.not.eof()
   IF plan<>0
...
PROCEDURE TOKPRE
   ...
   DO idel WITH (kkockax3)
        ...
        ENDIF         
         ...
         LOCATE FOR AOP='302'
         IF MB302>0
            REPLACE REALKV  WITH MB302
         ENDIF
         LOCATE FOR AOP='303'
         IF MB303>0
            REPLACE REALKV  WITH MB303
         ENDIF
         LOCATE FOR AOP='304'
         IF MB304>0
            REPLACE REALKV  WITH MB304
         ENDIF
         LOCATE FOR AOP='306'
         IF MB306>0
            REPLACE REALKV  WITH MB306
         ENDIF
         LOCATE FOR AOP='307'
         IF MB307>0
            REPLACE REALKV  WITH MB307
         ENDIF
         LOCATE FOR AOP='308'
         IF MB308>0
            REPLACE REALKV  WITH MB308
         ENDIF
         LOCATE FOR AOP='309'
         IF MB309>0
            REPLACE REALKV  WITH MB309
         ENDIF
         LOCATE FOR AOP='310'
         IF MB310>0
            REPLACE REALKV  WITH MB310
         ENDIF
         LOCATE FOR AOP='314'
         IF MB314>0
            REPLACE REALKV  WITH MB314
         ENDIF
         LOCATE FOR AOP='315'
         IF MB315>0
            REPLACE REALKV  WITH MB315
         ENDIF
         LOCATE FOR AOP='316'
         IF MB316>0
            REPLACE REALKV  WITH MB316
         ENDIF
         LOCATE FOR AOP='317'
         IF MB317>0
            REPLACE REALKV  WITH MB317
         ENDIF
         LOCATE FOR AOP='326'
         IF MB326>0
            REPLACE REALKV  WITH MB326
         ENDIF
         LOCATE FOR AOP='327'
         IF MB327>0
            REPLACE REALKV  WITH MB327
         ENDIF
         LOCATE FOR AOP='328'
         IF MB328>0
            REPLACE REALKV  WITH MB328
         ENDIF
         LOCATE FOR AOP='330'
         IF MB330>0
            REPLACE REALKV  WITH MB330
         ENDIF
         LOCATE FOR AOP='331'
         IF MB331>0
            REPLACE REALKV  WITH MB331
         ENDIF
         LOCATE FOR AOP='332'
         IF MB332>0
            REPLACE REALKV  WITH MB332
         ENDIF
         LOCATE FOR AOP='333'
         IF MB333>0
            REPLACE REALKV  WITH MB333
         ENDIF
