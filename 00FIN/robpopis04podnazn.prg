...
SET ORDER TO 1 
   ...
   IF mtxtKOL='N'
      IF AGDE=0
         *REPORT FORM ROBPOPISPODDNN PREVIEW FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
   ...
   DO printer_bullzip WITH mdata02,mfiLE,USLOV
      ...
      ELSE
         REPORT FORM ROBPOPISPODDNN TO PRINTER PROMPT FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
         .AND.(GRUPA1=MGRUPA1.OR.MGRUPA1=SPACE(3));
         .AND.(GRUPA2=MGRUPA2.OR.MGRUPA2=SPACE(3));
         .AND.(GRUPA3=MGRUPA3.OR.MGRUPA3=SPACE(3));
         .AND.(GRUPA4=MGRUPA4.OR.MGRUPA4=SPACE(3));
   ...
   ELSE
      IF AGDE=0
         *REPORT FORM ROBPOPISPODKDNN PREVIEW FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
         .AND.(GRUPA1=MGRUPA1.OR.MGRUPA1=SPACE(3));
         .AND.(GRUPA2=MGRUPA2.OR.MGRUPA2=SPACE(3));
         .AND.(GRUPA3=MGRUPA3.OR.MGRUPA3=SPACE(3));
         .AND.(GRUPA4=MGRUPA4.OR.MGRUPA4=SPACE(3));
   ...
   DO printer_bullzip WITH mdata02,mfiLE,USLOV
      ...
      ELSE
         REPORT FORM ROBPOPISPODKDNN TO PRINTER PROMPT FOR (GRUPA=MGRUPA.OR.MGRUPA=SPACE(3));
         .AND.(GRUPA1=MGRUPA1.OR.MGRUPA1=SPACE(3));
         .AND.(GRUPA2=MGRUPA2.OR.MGRUPA2=SPACE(3));
         .AND.(GRUPA3=MGRUPA3.OR.MGRUPA3=SPACE(3));
         .AND.(GRUPA4=MGRUPA4.OR.MGRUPA4=SPACE(3));
