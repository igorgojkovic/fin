...
mm='}'
FPUTS(bobi,MM)
********koristimo ovo za paginaciju**********/
mm='$prikaz =16 ;  '
FPUTS(bobi,MM)
mm='$strukupno = ceil($brojunosa/$prikaz); '
FPUTS(bobi,MM)
mm="if (isset($_GET['strana']))"
FPUTS(bobi,MM)
mm='{'
FPUTS(bobi,MM)
mm="   $trenutnastr = $_GET['strana'];"
FPUTS(bobi,MM)
mm='}'
FPUTS(bobi,MM)
mm='else'
...
mm='}'
FPUTS(bobi,MM)
mm='elseif ($trenutnastr > $strukupno) '
FPUTS(bobi,MM)
mm='{'
FPUTS(bobi,MM)
mm='   $trenutnastr = $strukupno;'
FPUTS(bobi,MM)
mm='}'
FPUTS(bobi,MM)
mm='$poc = ($trenutnastr - 1) * $prikaz; '
FPUTS(bobi,MM)
mm='$prethodna = $trenutnastr - 1;'
FPUTS(bobi,MM)
mm='$naredna = $trenutnastr + 1;'
FPUTS(bobi,MM)
mm='$upit = "SELECT * FROM $tablename limit $poc,$prikaz ";'
FPUTS(bobi,MM)
mm='$rezultat=mysql_query($upit);'
FPUTS(bobi,MM)
mm='if ($rezultat)'
...
**************************
mm='   <div id="paginacija" >'
FPUTS(bobi,MM)
mm='   <?php'
FPUTS(bobi,MM)
aa="&"
ab="&"
mm="   if ($strukupno"+" > + $trenutnastr "+aa+ab+ " $trenutnastr <= 1)"
FPUTS(bobi,MM)
mm='   {'
FPUTS(bobi,MM)
mm='      echo ("<span style=\"color:gray;\">Prva &nbsp < Preth &nbsp</span> Strana &nbsp ". $trenutnastr ."&nbsp od &nbsp {$strukupno} &nbsp <a href=\"?strana={$naredna}&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\">Sled></a> &nbsp <a href=\"?strana={$strukupno}&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\">Zad></a>");'
FPUTS(bobi,MM)
mm='   }'
FPUTS(bobi,MM)
mm='   elseif ($trenutnastr == $strukupno '+aa+ab+' $strukupno == 1)'
FPUTS(bobi,MM)
mm='   {'
FPUTS(bobi,MM)
mm='      echo ("Strana &nbsp ". $trenutnastr ."&nbsp od &nbsp {$strukupno} &nbsp ");'
FPUTS(bobi,MM)
mm='   }'
FPUTS(bobi,MM)
mm='   elseif ($strukupno > $trenutnastr '+aa+ab+' $trenutnastr >= 1)'
FPUTS(bobi,MM)
mm='   {'
FPUTS(bobi,MM)
mm='      echo ("<a href=\"?strana=1&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\">Prva</a> &nbsp <a href=\"?strana={$prethodna}&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\"> < Preth</a> &nbsp Strana &nbsp ". $trenutnastr ."&nbsp od &nbsp {$strukupno} &nbsp <a href=\"?strana={$naredna}&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\"> Sled ></a> &nbsp <a href=\"?strana={$strukupno}&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\">Zad</a>");'
FPUTS(bobi,MM)
mm='   }'
FPUTS(bobi,MM)
mm='   elseif ($strukupno == $trenutnastr)'
FPUTS(bobi,MM)
mm='   {'
FPUTS(bobi,MM)
mm='      echo ("<a href=\"?strana=1&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\">Prva</a> &nbsp <a href=\"?strana={$prethodna}&mtabela={$_SESSION['+"'"+'tabela'+"'"+']}\"> < Preth</a> &nbsp Strana &nbsp ". $trenutnastr ."&nbsp od &nbsp {$strukupno} &nbsp <span style=\"color:gray;\">Sled > &nbsp Zad</span>");'
FPUTS(bobi,MM)
mm='   }'
FPUTS(bobi,MM)
mm='?>'
