...
***********************************
      ...
      REPLACE PRETHP WITH NP0010P      
      REPLACE NETO  WITH NN0010
**************************************************
      SEEK '0019'
      ...
      REPLACE PRETHP WITH NP0019P      
      REPLACE NETO  WITH NN0019
***********************************************
...
*******************************************************
      ...
      REPLACE PRETHP WITH NP0034P      
      REPLACE NETO  WITH NN0034
**********************************************************
      ...
      REPLACE PRETHP WITH NP0044P      
      REPLACE NETO  WITH NN0044
***********************************************************
      SEEK '0051'
      ...
      REPLACE PRETHP WITH NP0051P      
      REPLACE NETO  WITH NN0051
...
***********************************************************
      ...
      REPLACE PRETHP WITH NP0062P      
      REPLACE NETO  WITH NN0062
...
*************PASIVA********************
      ...
      REPLACE PRETHP WITH NP0402P      
      REPLACE NETO  WITH NN0402
****************************************
      SEEK '0417'
      ...
      REPLACE PRETHP WITH NP0417P      
      REPLACE NETO  WITH NN0417
***************************************
      SEEK '0421'
...
*************************************
      ...
      REPLACE PRETHP WITH NP0425P      
      REPLACE NETO  WITH NN0425
**************************************************
      ...
      REPLACE PRETHP WITH NP0432P      
      REPLACE NETO  WITH NN0432
*************************************************
      SEEK '0443'
      ...
      REPLACE PRETHP WITH NP0443P      
      REPLACE NETO  WITH NN0443
...
********************************************************
      ...
      REPLACE PRETHP WITH NP0451P      
      REPLACE NETO  WITH NN0451
...
************DRUGI NIVO BS************************************
      ...
      REPLACE PRETHP WITH NP0002P      
      REPLACE NETO  WITH NN0002
*******************************************************
      SEEK '0043'
      ...
      REPLACE PRETHP WITH NP0043P      
      REPLACE NETO  WITH NN0043
************TRECI  NIVO BS AKTIVA************************************
      ...
      REPLACE PRETHP WITH NP0071P      
      REPLACE NETO  WITH NN0071
*******************************************************
*************BS PASIVA*********************************
      SEEK '0401'
...
*******************************************************
      ...
      REPLACE PRETHP WITH NP0424P      
      REPLACE NETO  WITH NN0424
******************************************************
      SEEK '0442'
      ...
      REPLACE PRETHP WITH NP0442P      
      REPLACE NETO  WITH NN0442
*******************************************************
      SEEK '0463'
      ...
      REPLACE PRETHP WITH NP0463P      
      REPLACE NETO  WITH NN0463
      IF NP0463<0
         REPLACE PRETH WITH 0
         NP0463=0
      ENDIF         
      IF NP0463P<0
         REPLACE PRETHP WITH 0
         NP0463P=0
      ENDIF         
      IF NN0463<0
         REPLACE NETO WITH 0
...
*******************************************************
      ...
      REPLACE PRETHP WITH NP0464P      
      REPLACE NETO  WITH NN0464
...
*****************************************************
         ...
         MK0022=PUNIZN02('037')
         MK0022=MK0022+PUNIZN08('0397')

         MK0023=PUNIZN02('038')
         MK0023=MK0023+PUNIZN08('0398')
...
***************************************
         ...
         MK0036=PUNIZN02('051')
         MK0036=MK0036+PUNIZN08('0591')
         MK0037=PUNIZN02('052')
         MK0037=MK0037+PUNIZN08('0592')
         MK0038=PUNIZN02('053')
         MK0038=MK0038+PUNIZN08('0593')
         MK0039=PUNIZN02('054')
         MK0039=MK0039+PUNIZN08('0594')
         MK0040=PUNIZN02('055')
         MK0040=MK0040+PUNIZN08('0595')
         MK0041=PUNIZN02('056')
         MK0041=MK0041+PUNIZN08('0596')
         MK0042=PUNIZN02('288')
         MK0045=PUNIZN01('10')
         MK0046=PUNIZN01('11')
         MK0047=PUNIZN01('12')
...
*******************BILANS USPEHA******************************
         ...
         MK1057=PUNIZN02('590')
         MK1057=MK1057+PUNIZN02('591')
         MK1057=MK1057+PUNIZN02('592')         
