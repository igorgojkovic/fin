...
IF ABROJ=1
   IF AGDE=1
      REPORT FORM FAK2D FOR BRKAL=MBRKAL TO PRINTER
   ELSE
      *REPORT FORM FAK2D FOR BRKAL=MBRKAL PREVIEW
      mfile='FAK2D'
      uslov="BRKAL=MBRKAL"
...
ELSE
   IF AGDE=1
      REPORT FORM FAK2DMARZA FOR BRKAL=MBRKAL TO PRINTER
   ELSE
      *REPORT FORM FAK2DMARZA FOR BRKAL=MBRKAL PREVIEW
      mfile='FAK2DMARZA'
      uslov="BRKAL=MBRKAL"
      DO printer_bullzip WITH mdata02,mfile,uslov
