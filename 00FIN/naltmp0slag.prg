...
*USE TMP0 IN 0
SELECT TMP
COPY TO &KKOCKA2 FOR MATTR<>0.OR.plate<>0.OR.OSTRASH<>0
*USE   
...
TOTAL ON BRNAL FIELDS MATTR,PLATE,OSTRASH TO &KKOCKA3
ZAP
APPEND FROM &KKOCKA3
SET ORDER TO 1
GO TOP
...
USE NAL IN 0
SELECT NAL
COPY TO &KKOCKA4 FOR SUBSTR(konto,1,1)='5'.AND.SUBSTR(konto,1,2)<>'50'
USE
...
ENDDO   
GO TOP
TNAZIV=' KNJIGA PRIHODA I RASHODA '
TOBJEKAT='0'
TTVREDNI='0'
*REPORT FORM TVGKSLAG PREVIEW FOR dsaldo<>0
   mfile='TVGKSLAG'
   uslov="dsaldo<>0"
