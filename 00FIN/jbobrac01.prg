...
*------------OBRACUN ZA KANALIZACIJU
      IF PKANAL<>' '
*         IF POPKAN<>0
*         MSOCKANAL=ROUND(BRSTAN*MCKANAL,2)
*         ELSE
*         MSOCKANAL=0
*         ENDIF
         REPLACE KANAL WITH ROUND(BRSTAN*MCKANAL*MMES,2)
...
IF PSMECE<>' '
  ...
  * MSOCSMECEP=0
  * ENDIF
   REPLACE SMECE WITH ROUND(POV*MCSMECE*MMES,2)
...
*-------OBRACUN RABATA-----------------   
   ...
   IF IMARABAT=1
      MRABOSNOV=VODA+DOPV+KANAL+DOPK+SMECE
   ELSE
      MRABOSNOV=0
   ENDIF      
   IF MRABOSNOV>0
...
*----OBRACUN UKUPNO---------------------
   MUKUPNO=VODA+DOPV+KANAL+DOPK+SMECE+ODRZ
...
*   MIME_PREZ=ALLTRIM(PREZ)+' '+IME
   ...
   *----------POREZ------------
   ...
   REPLACE POR8 WITH MPOR8
   REPLACE POR18 WITH MPOR18
   REPLACE POSTA WITH AN00.POSTA0
   REPLACE MESTO WITH AN00.MESTO0
   REPLACE PREZ WITH AN00.PREZ
   REPLACE IME WITH AN00.IME
   REPLACE ULICA0 WITH AN00.ULICA0
   REPLACE ULBROJ0 WITH AN00.ULBROJ0   
   REPLACE MES WITH MMES
   SCATTER NAME POLJA
*---------DODAVANJE POLJA-----------
   SELECT VPUPLD
